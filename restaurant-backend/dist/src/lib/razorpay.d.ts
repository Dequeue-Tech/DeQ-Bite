...
export declare function refundRazorpayPayment(paymentId: string, amount?: number, reason?: string): Promise<import("razorpay/dist/types/refunds").Refunds.RazorpayRefund>;
